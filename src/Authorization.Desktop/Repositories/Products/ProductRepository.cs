...
public class ProductRepository : BaseRepository, IProductRepository
{
    ...
    public async Task<IList<ProductAllToStorageViewModel>> GetAllProductToStorage()
    {
        ...
        {
            await _connection.OpenAsync();
            string query = "Select products.id,products.subcategory_id, products.bar_code,categories.name as 'Category',subcategories.name as 'Subcategory', products.name,products.quantity,products.sold_price,products.price " +
